...
class HTMLReportCreator(object):
    ...
    def render_general_page(self):
        ...
        project_data = {
            ...
            "active_days_count": self.git_repo_statistics.active_days_count,
    ...
    def render_authors_page(self):
        ...
        raw_authors_data = self.git_repo_statistics\
            .get_authors_by_month()
        ordered_months = raw_authors_data.index.get_level_values(0).unique().sort_values(ascending=False)
        #print(self.configuration['max_authors_of_months'], ordered_months[0:self.configuration['max_authors_of_months']])
        project_data['months'] = []
        ...
        project_data['years'] = []
        raw_authors_data = self.git_repo_statistics.get_authors_ranking_by_year()
